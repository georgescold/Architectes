...
Le risque n'est pas de se tromper, c'est de blesser. Un quart de la profession vit sous
13 342 euros par an, et certains de tes spectateurs ont vu un confrère être liquidé cette
année.

Débit ralenti sur ce passage, aucun commentaire moral, aucune emphase. Le chiffre travaille
tout seul.

Second piège : ne nomme jamais un cabinet et ne compare pas deux confrères. L'ennemi de
cette vidéo est une idée, jamais une personne.
...
### 2. D'où je parle et de quand datent ces chiffres

À faire comprendre : que je manipule des données précises et que je sais lesquelles.

Exemple de formulation :
« Je fais de l'acquisition pour des cabinets d'architecture. C'est mon métier d'aller
chercher des clients pour les vôtres, donc c'est aussi mon métier de comprendre qui gagne
quoi dans ce marché. J'ai lu les 83 pages.
...
À faire comprendre : l'ampleur réelle, sans commentaire.
...
### 4. Pourquoi « c'est la conjoncture » ne tient pas
...
### 5. Le décalage qui trompe tout le monde

À faire comprendre : qu'un carnet plein aujourd'hui ne dit rien de l'année prochaine.
C'est de l'acquisition, pas du métier.

Exemple de formulation :
« L'objection que j'entends tout le temps, c'est "moi ça va, j'ai des projets en cours".
C'est exactement le piège. Vous facturez aujourd'hui des projets signés l'an dernier.
Quand le vide se sent, il est installé depuis plusieurs trimestres — et remplir un carnet
prend des mois de plus.

Votre carnet de commandes n'est pas un thermomètre. C'est un rétroviseur. »


### 6. La page que personne ne cite

À faire comprendre : que le métier paie, mais tard, et pourquoi — c'est la bascule de la
vidéo.
...
### 7. Ce qui sépare réellement les deux extrémités

À faire comprendre : que la variable n'est pas le talent ni l'ancienneté seule, mais le
nombre de sources de projets. On entre dans son domaine.

Exemple de formulation :
« Je vois passer beaucoup de cabinets, et je vais vous dire ce qui les distingue. Ce n'est
pas la qualité du travail — j'ai vu des portfolios magnifiques avec un carnet vide. Ce
n'est pas la taille non plus.

C'est le nombre de portes d'entrée. Le bas dépend d'une seule source : la recommandation.
Le haut en a plusieurs. Et ce n'est pas un hasard : quand une source se ferme, celui qui
en a quatre ne s'en aperçoit presque pas. Celui qui en a une ferme boutique. »


### 8. LE BLOC ACQUISITION — deux minutes pleines, jamais expédié

À faire comprendre : que la recommandation a un défaut structurel de temps, et que la
...
Elle a même un deuxième défaut, plus cruel : elle s'éteint quand votre réseau de
prescripteurs part à la retraite en même temps que vous. C'est exactement ce que raconte
la courbe qui redescend après 65 ans.
...
d'abord lequel des leviers existe déjà — il y en a presque toujours un — et on monte le
suivant. C'est moins spectaculaire que de tout refaire, et c'est ce qui tient. »

Puis le document, enchaîné sans respirer :
« Tous les leviers, ce que chacun coûte, dans quel ordre les monter : c'est un document
de 57 pages, gratuit, lien en description. Pas de carte bancaire, pas d'appel commercial. »
https://essort.agency/ressources


### 9. Sortie

À faire comprendre : qu'une action simple est possible cette semaine, et rouvrir une
tension.

Exemple de formulation :
« Personne ne change de quartile en un trimestre. Mais passer d'une source de projets à
deux, ça se fait en un mois, et ça change l'année suivante. Comptez les vôtres ce soir :
la plupart des gens en ont une.

Et si vous vous dites que de toute façon vous n'avez pas le droit de faire de la
publicité — c'est faux depuis 1992, et je vous montre le texte dans la vidéo suivante. »
...
Je fais de l'acquisition pour des cabinets d'architecture. J'ai lu les 83 pages.
...
Archigraphie 2024-2026, CNOA, 83 p. : https://www.architectes.org/sites/cnoa/files/2025-04/ARCHIGRAPHIE-2024_13decembre_WEB_0.pdf
  graphique 19 p. 32 — seuils de revenus par quartile, source CIPAV
...
Chaque chiffre visible à l'écran dans sa source au moment où il est prononcé.
