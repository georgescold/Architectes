# EP15 — Le marché n'a pas disparu, il a changé d'adresse

Épisode 15/20 · RÈGLE · architecte DE et architecte d'intérieur · 13-15 min


## LA BIG IDEA

Pendant qu'on parle de la chute des permis de construire, un autre marché monte, il est
public et il est chiffré : la rénovation d'ampleur financée.

Et il y a un fait que la profession vit sans toujours le formuler : la rénovation
représente déjà 62 % des travaux déclarés par les architectes en volume — mais seulement
38 % en valeur. Autrement dit, c'est là que sont les projets, et ce sont des projets plus
petits. Il en faut donc davantage, et plus régulièrement.
...
rénovations d'ampleur et 150 000 rénovations par geste. Le parcours accompagné devient
obligatoire pour les logements classés F ou G, et l'isolation des murs sort du parcours par
geste.
...
C'est l'épisode le plus périssable de la chaîne. Le dispositif a été suspendu puis rouvert
en deux mois. Revérifie tout la veille du tournage, et affiche la date du relevé à l'écran.

N'annonce aucune échéance future que tu n'as pas sourcée. L'ancienne version de cette fiche
mentionnait une obligation au 1er janvier 2027 : je n'ai pas trouvé de source pour
l'étayer, elle est retirée.

Second piège : ne présente pas la rénovation comme un eldorado. Le volume y est, la valeur
unitaire non — et c'est écrit noir sur blanc dans Archigraphie. Le dire renforce ta
crédibilité et amène naturellement le sujet du flux régulier.


## LES OBJECTIONS QUI ARRIVERONT EN COMMENTAIRE

« Ces chantiers sont petits et pénibles. »
Sur la rénovation par geste, souvent. Sur la rénovation d'ampleur, c'est autre chose — et
les chiffres d'Archigraphie confirment que les honoraires y sont moindres qu'en neuf. Je
le dis dans la vidéo plutôt que de le cacher.

« Le dispositif change tous les six mois, on ne peut pas construire là-dessus. »
C'est vrai, et c'est même l'argument : un marché instable pour les particuliers est un
marché où l'accompagnement a de la valeur.

« Les mandataires et les groupements ont déjà pris la place. »
Ils communiquent massivement, oui. C'est justement le sujet de la fin de la vidéo.

« Je ne veux pas faire de l'audit énergétique. »
Personne ne le demande. La rénovation d'ampleur est une mission de conception et de
...
À faire comprendre : qu'un marché monte pendant qu'on regarde celui qui baisse.

Exemple de formulation :
« On parle beaucoup de la chute des permis de construire. Pendant ce temps, il y a un
marché qui monte, qui est public, et qui est chiffré : 3,6 milliards d'euros pour 2026, et
un objectif d'au moins 120 000 rénovations d'ampleur. »
...
chercher des clients pour les vôtres — donc quand un dispositif public déplace des
centaines de milliers de propriétaires vers un type de travaux, c'est exactement le genre
de chose que je regarde. »


### 3. L'état du dispositif — deux minutes maximum

À faire comprendre : où en est MaPrimeRénov', avec la date du relevé.

Exemple de formulation :
« Rapidement, l'état des lieux au jour où j'enregistre. Le dispositif a été suspendu au
1er janvier faute de budget voté, puis le guichet a rouvert le 23 février. Budget 2026 :
3,6 milliards, contre 3,4 l'an dernier.

Deux changements importants : le parcours accompagné devient obligatoire pour les logements
classés F et G, et l'isolation des murs sort du parcours par geste — elle n'est plus
éligible qu'en rénovation d'ampleur.

Ce dispositif bouge tous les trimestres. Vérifiez avant de vous appuyer dessus, le lien est
en description. »
...
### 4. Ce que ça déplace concrètement

À faire comprendre : que ça crée une population de propriétaires avec une contrainte et un
budget.

Exemple de formulation :
« Ce que ça produit, c'est une population très identifiable : des propriétaires de maison
classée F ou G, qui ne peuvent plus faire des travaux au coup par coup, qui doivent passer
par un parcours accompagné, et qui ont une partie du financement sécurisée.

Un client avec une contrainte et un budget partiellement couvert, c'est un client qui
décide. »


### 5. La nuance que personne ne dit

À faire comprendre : le volume contre la valeur, qui est le cœur honnête de l'épisode.

Exemple de formulation :
« Maintenant la nuance, et elle est importante parce que sinon je vous vendrais du rêve.

Archigraphie le dit avec les chiffres de la MAF : en 2022, l'entretien-rénovation
représentait 62 % des travaux déclarés par les architectes en volume. Mais en valeur, le
neuf pesait 62 % et la rénovation seulement 38 %.

En clair : c'est là que sont les projets, et ce sont des projets plus petits. Le document
écrit même que ces travaux entraînent des honoraires moindres que sur le neuf.

Donc ce n'est pas un eldorado. C'est un marché de volume — ce qui change complètement la
façon dont il faut aller le chercher. »

Preuve — Archigraphie, pages 52-53.
https://www.architectes.org/sites/cnoa/files/2025-04/ARCHIGRAPHIE-2024_13decembre_WEB_0.pdf


### 6. Pourquoi votre réseau ne vous y emmènera pas

À faire comprendre : que ce marché est structurellement invisible depuis la recommandation.

Exemple de formulation :
« Et voilà le problème. Un propriétaire de passoire thermique ne passe pas par un notaire,
ni par un agent immobilier, ni par un promoteur. Il n'est dans le réseau de personne.

Il tape une question dans un moteur de recherche, ou il voit passer quelque chose. Votre
réseau de prescripteurs, aussi bon soit-il, n'a tout simplement pas son adresse.

Vous n'avez pas raté cette vague par négligence : elle n'était pas visible depuis là où
vous regardez. »


### 7. LE BLOC ACQUISITION — deux minutes pleines, jamais expédié

À faire comprendre : qu'un marché de volume exige un flux régulier, que seule la publicité
en ligne produit sur un profil aussi précis.

Exemple de formulation :
« Reprenons la nuance de tout à l'heure, parce que tout en découle. Marché de volume,
honoraires unitaires plus faibles : ça veut dire qu'il vous faut plus de projets, et
surtout un flux régulier. Deux missions par an ne changent rien ; une par mois change une
année.

Or un flux régulier, la recommandation ne sait pas le produire. Elle produit par à-coups,
et elle n'a pas l'adresse de ces gens-là.

La publicité en ligne, elle, sait exactement faire ça — et c'est presque le cas d'école. Le
profil est identifiable : propriétaire d'une maison des années 1950 à 1990, une certaine
tranche d'âge, un département. Vous pouvez vous adresser à ces gens précisément, sur votre
zone, et ajuster le volume selon ce que votre agenda peut absorber.

Et il y a urgence, au sens commercial : les mandataires et les groupements de travaux sont
déjà positionnés et communiquent massivement. Quand ces propriétaires cherchent, ce sont
eux qu'ils trouvent. Pas vous. »

Puis, au nous :
« Chez Essort, c'est un des profils les plus faciles à cibler qu'on ait — parce que la
contrainte réglementaire fait le tri à notre place. Le client sait qu'il doit faire des
travaux, il cherche juste avec qui. »
...
Exemple de formulation :
« Cette semaine : une page sur la rénovation d'ampleur, avec votre zone et un ordre de
grandeur. Ce mois-ci : une campagne sur ce profil précis. Ce trimestre : les premiers
rendez-vous.

Et vérifiez l'état du dispositif avant de vous lancer. Il a déjà été suspendu une fois
cette année. »
...
droite, maison ancienne à gauche.


## DESCRIPTION YOUTUBE

```
3,6 milliards d'euros pour 2026 et un objectif d'au moins 120 000 rénovations d'ampleur.
Le parcours accompagné devient obligatoire pour les logements F et G. C'est un marché
public, chiffré, et invisible depuis un réseau de prescripteurs.

La nuance que je donne dans la vidéo : la rénovation représente 62 % des travaux déclarés
par les architectes en volume, mais seulement 38 % en valeur. C'est un marché de volume,
pas un eldorado.

Dispositif au jour de l'enregistrement. Il a déjà été suspendu puis rouvert cette année :
vérifiez avant de vous appuyer dessus.
...
Archigraphie 2024-2026, pages 52-53, source MAF : https://www.architectes.org/sites/cnoa/files/2025-04/ARCHIGRAPHIE-2024_13decembre_WEB_0.pdf

Instagram : https://instagram.com/essort.architectes
```

Mots-clés : MaPrimeRénov 2026 · rénovation d'ampleur architecte · passoire thermique
travaux · marché rénovation architecte


## GARDE-FOUS

Revérifier l'état du dispositif la veille du tournage et afficher la date du relevé.
N'annoncer aucune échéance future non sourcée : la mention d'une obligation au 1er janvier
2027 a été retirée faute de source.
